#!/usr/bin/env python3
"""
RecBole AutoML - MultiVAE Hyperparameter Optimization with Ray Tune
...
# 하이퍼파라미터 탐색 공간 (RecBole 문서 + MultiVAE 논문 기반)
...
search_space = {
    ...
    'dropout_prob': tune.uniform(0.3, 0.7),                # 기본: 0.5
    'anneal_cap': tune.choice([0.1, 0.2, 0.3]),            # KL 손실 가중치, 기본: 0.2
...
print(f"   anneal_cap: [0.1, 0.2, 0.3] (KL 가중치)")
